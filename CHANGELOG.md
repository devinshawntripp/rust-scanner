...
### Fixed
- DMG detection priority: check DMG (extension + koly trailer) before tar magic bytes —
  bzip2-compressed UDIF DMGs were misrouted to the tar pipeline and failing with
  "numeric field did not have utf-8 text" because UDIF internally uses bzip2 compression
